...
define gui.about = _p("""Игра создана 1 типом с колледжа, которому задали проект по программированию

можете украсть её и продать на чёрном рынке, но вас скорее всего посадят за тупость.
Игра не предназначена для широкого распространения и\или продажи.

P.S. не покупайте её не при каких обстоятельствах.
""")
...
#define config.main_menu_music = "DarkAmbient.mp3"
...
define config.save_directory = "RedGrin-1650189305"
