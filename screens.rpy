...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Назад") activate_sound "audio/buttonclick.mp3" action Rollback()
            textbutton _("История") activate_sound "audio/buttonclick.mp3" action ShowMenu('history')
            textbutton _("Пропуск") activate_sound "audio/buttonclick.mp3" action Skip() alternate Skip(fast=True, confirm=True)
            textbutton _("Авто") activate_sound "audio/buttonclick.mp3" action Preference("auto-forward", "toggle")
            textbutton _("Сохранить") activate_sound "audio/buttonclick.mp3" action ShowMenu('save')
            #textbutton _("Б.Сохр") activate_sound "audio/buttonclick.mp3" action QuickSave()
            #textbutton _("Б.Загр") activate_sound "audio/buttonclick.mp3" action QuickLoad()
            textbutton _("Опции") activate_sound "audio/buttonclick.mp3" action ShowMenu('preferences')
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            textbutton _("Начать"):
              activate_sound "audio/buttonclick.mp3"
              action Start()
        else:
        ...
        textbutton _("Загрузить")  activate_sound "audio/buttonclick.mp3" action ShowMenu("load")

        textbutton _("Настройки")  activate_sound "audio/buttonclick.mp3" action ShowMenu("preferences")

        if _in_replay:

            textbutton _("Завершить повтор")  activate_sound "audio/buttonclick.mp3" action EndReplay(confirm=True)

        elif not main_menu:

            textbutton _("Главное меню")  activate_sound "audio/buttonclick.mp3" action MainMenu()

        textbutton _("Об игре")  activate_sound "audio/buttonclick.mp3" action ShowMenu("about")

        if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):

            ## Помощь не необходима и не относится к мобильным устройствам.
            textbutton _("Помощь")  activate_sound "audio/buttonclick.mp3" action ShowMenu("help")

        if renpy.variant("pc"):

            ## Кнопка выхода блокирована в iOS и не нужна на Android и в веб-
            ## версии.
            textbutton _("Выход")  activate_sound "audio/buttonclick.mp3" action Quit(confirm=not main_menu)
...
screen main_menu():
    ...
    python:
     renpy.music.queue("DarkAmbient.mp3", channel = "music", fadein = 5)
     renpy.music.queue("audio/RainSounds1.mp3", channel = "sound", fadein = 5)
    ...
    use game_menu(title):
        ...
        fixed:
            ...
            hbox:
                ...
                textbutton _("(") activate_sound "audio/buttonclick.mp3" action FilePagePrevious()

                if config.has_autosave:
                    textbutton _("{#auto_page}А") activate_sound "audio/buttonclick.mp3" action FilePage("auto")

                if config.has_quicksave:
                    textbutton _("{#quick_page}Б") activate_sound "audio/buttonclick.mp3" action FilePage("quick")

                ## range(1, 10) задаёт диапазон значений от 1 до 9.
                for page in range(1, 10):
                    textbutton "[page]" activate_sound "audio/buttonclick.mp3" action FilePage(page)

                textbutton _(">") activate_sound "audio/buttonclick.mp3" action FilePageNext()
            ...
            hbox:
                ...
                if renpy.variant("pc") or renpy.variant("web"):
                    ...
                    vbox:
                        ...
                        textbutton _("Оконный") activate_sound "audio/buttonclick.mp3" action Preference("display", "window")
                        textbutton _("Полный") activate_sound "audio/buttonclick.mp3" action Preference("display", "fullscreen")

                vbox:
                    style_prefix "radio"
                    label _("Сторона отката")
                    textbutton _("Отключено") activate_sound "audio/buttonclick.mp3" action Preference("rollback side", "disable")
                    textbutton _("Левая") activate_sound "audio/buttonclick.mp3" action Preference("rollback side", "left")
                    textbutton _("Правая") activate_sound "audio/buttonclick.mp3" action Preference("rollback side", "right")

                vbox:
                    style_prefix "check"
                    label _("Пропуск")
                    textbutton _("Всего текста") activate_sound "audio/buttonclick.mp3" action Preference("skip", "toggle")
                    textbutton _("После выборов") activate_sound "audio/buttonclick.mp3" action Preference("after choices", "toggle")
                    textbutton _("Переходов") activate_sound "audio/buttonclick.mp3" action InvertSelected(Preference("transitions", "toggle"))
    ...
    use game_menu(_("Помощь"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                textbutton _("Клавиатура") activate_sound "audio/buttonclick.mp3" action SetScreenVariable("device", "keyboard")
                textbutton _("Мышь") activate_sound "audio/buttonclick.mp3" action SetScreenVariable("device", "mouse")

                if GamepadExists():
                    textbutton _("Геймпад") activate_sound "audio/buttonclick.mp3" action SetScreenVariable("device", "gamepad")
...
screen gamepad_help():
    ...
    textbutton _("Калибровка") activate_sound "audio/buttonclick.mp3" action GamepadCalibrate()
    ...
    frame:
        ...
        vbox:
            ...
            hbox:
                ...
                textbutton _("Да")  activate_sound "audio/buttonclick.mp3" action yes_action
                textbutton _("Нет")  activate_sound "audio/buttonclick.mp3" action no_action
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Пропуск") activate_sound "audio/buttonclick.mp3" action Skip() alternate Skip(fast=True, confirm=True)
            textbutton _("Авто") activate_sound "audio/buttonclick.mp3" action Preference("auto-forward", "toggle")
            textbutton _("Меню") activate_sound "audio/buttonclick.mp3" action ShowMenu()
